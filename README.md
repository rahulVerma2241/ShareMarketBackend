# This is the API backend for share market API
## Project Motivation
...
#### Local application 
1. Create the mvn build and generate the jar
```
$ mvn clean install
```
...
```
$ docker build -t 1rahul23/sharebackend .
```
#### Docker container run command
```
$ docker run -p 8081:8081 1rahul23/sharebackend
```
